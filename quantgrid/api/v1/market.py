...
from quantgrid.services.quant_service import quant_service, TechnicalAnalysis
...
async def get_prices_from_db(ticker: str, limit: int = 100):
    ...
    """
    try:
        from quantgrid.db.session import timescale_session_maker
        from quantgrid.services.market_data_service import market_data_service
...
async def get_market_data(
    ...
    **Cache Behavior:**
    ...
    """
    from quantgrid.services.market_state_manager import market_state_manager, AssetClass
    from quantgrid.db import get_timescale_session
...
async def quick_ingest(
    ...
    """
    try:
        from quantgrid.engine.ingestion.yfinance_connector import yfinance_connector
        from quantgrid.engine.ingestion.binance_connector import binance_connector
        from quantgrid.db.session import timescale_session_maker
        from quantgrid.services.market_data_service import market_data_service
