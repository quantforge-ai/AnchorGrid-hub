...
from quantgrid.services.quote_service import (
    get_realtime_quote,
    get_historical_data,
    get_batch_quotes
)
...
async def get_market_movers():
    ...
    """
    from quantgrid.services import quote_service
...
async def get_top_market_gainers():
    ...
    """
    from quantgrid.services.quote_service import get_top_gainers
...
async def get_top_market_losers():
    ...
    """
    from quantgrid.services.quote_service import get_top_losers
