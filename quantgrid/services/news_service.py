...
from quantgrid.core.config import get_settings
from quantgrid.services.redis_service import get_redis_client
from quantgrid.services.shadow_watch import track_activity
...
async def get_portfolio_news(user_id: int, limit: int = 15) -> List[Dict]:
    ...
    """
    from quantgrid.services.portfolio_service import get_portfolio_summary
