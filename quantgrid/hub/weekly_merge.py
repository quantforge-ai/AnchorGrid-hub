"""
QuantGrid Hub - Weekly Merge Script
...
from quantgrid.hub.merging import ModelSoup
from quantgrid.hub.registry import QuantGridHub
from quantgrid.core.versioning import ModelVersionManager
...
def weekly_merge():
    ...
    # 4. Save merged model
    output_path = output_dir / f"quantgrid-analyst-{version}"
...
if __name__ == "__main__":
    ...
    # 0 3 * * 0 cd /opt/quantgrid-hub && python -m quantgrid.hub.weekly_merge
