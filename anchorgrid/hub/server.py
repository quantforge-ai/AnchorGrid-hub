"""
AnchorGrid Hub - Community Portal Server
...
from anchorgrid.hub.auth import get_current_user
from anchorgrid.hub.evaluation import ProofOfLoss, EvaluationBenchmark

app = FastAPI(
    title="AnchorGrid Community Hub",
...
async def root():
    """Health check"""
    return {
        "service": "AnchorGrid Community Hub",
...
# To run this server:
# uvicorn anchorgrid.hub.server:app --reload --host 0.0.0.0 --port 8000
