...
from anchorgrid.workers.celery_app import celery_app
...
async def trigger_ingestion(
    ...
    """
    from anchorgrid.workers.tasks.ingestion_tasks import ingest_ohlcv
...
async def trigger_batch_ingestion(
    ...
    """
    from anchorgrid.workers.tasks.ingestion_tasks import ingest_multiple
