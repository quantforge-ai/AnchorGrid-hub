"""
AnchorGrid Core - Model Downloader
...
class ModelDownloader:
    ...
    def __init__(self, cache_dir: Optional[str] = None):
        self.cache_dir = cache_dir or str(Path.home() / ".cache" / "anchorgrid")
    ...
    def pull(self, registry_id: str, force: bool = False) -> str:
        ...
        # Convention: HF repo = "AnchorGrid-Community/{model-name}"
        hf_repo_id = f"AnchorGrid-Community/{model_name}"
