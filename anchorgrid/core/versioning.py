...
class ModelVersionManager:
    """
    Manages automatic model version updates from AnchorGrid Hub.
    ...
    def __init__(self, cache_dir: Optional[str] = None):
        """
        Args:
            cache_dir: Where to cache models (default: ~/.anchorgrid/models)
        """
        if cache_dir:
            self.cache_dir = Path(cache_dir)
        else:
            self.cache_dir = Path.home() / ".anchorgrid" / "models"
        
        self.cache_dir.mkdir(parents=True, exist_ok=True)
        self.hub_url = os.getenv("ANCHORGRID_HUB_URL", "https://hub.anchorgrid.dev")
    ...
    def get_installed_version(self, model_name: str = "anchorgrid-analyst") -> Optional[str]:
        """
    ...
    def check_for_updates(self, model_name: str = "anchorgrid-analyst") -> dict:
        """
    ...
    def auto_update(self, model_name: str = "anchorgrid-analyst", force: bool = False) -> str:
        """
    ...
    def get_model_path(
        self,
        model_name: str = "anchorgrid-analyst",
